...
export class Router {
    ...
    constructor(protected readonly options: BasicRouterOptions) {
        ...
        if (!options.configuration) {
            throw new Error('Router need init within scent use(callback) method');
        }
    }
    ...
    private get adaptor() {
        const scopeManager = this.configuration.get<ScopeManager>('instances.scopeManager');
